...
import { File, X, FileImage, FileVideo, FileAudio, FileArchive, FileText } from "lucide-react";
...
export function FileAttachment({ files, urls, onClear }: FileAttachmentProps) {
  ...
  return (
    <div className="space-y-2">
      {files.map((file, index) => renderPreview(file, urls[index], index))}
    </div>
  );
}
