...
export function CallStatusDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={() => {}}>
      <DialogContent className="max-w-xs w-full px-6 py-8 rounded-lg shadow-lg text-center animate-fade-in bg-primary text-primary-foreground relative ring-2 ring-primary">
